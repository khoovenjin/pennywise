...
//            widgetServiceIntent.setData(Uri.parse(widgetServiceIntent.toUri(Intent.URI_INTENT_SCHEME)));
            ...
            remoteView.setTextViewText(R.id.tv_total, context.getString(R.string.today_expenses_total, Utilities.getFormattedCurrency(Expense.getTotalExpensesByDateMode(IDateMode.MODE_TODAY))));
