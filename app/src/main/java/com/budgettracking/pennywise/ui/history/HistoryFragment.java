package com.budgettracking.pennywise.ui.history;
...
import com.budgettracking.pennywise.adapters.BaseExpenseAdapter;
...
import com.budgettracking.pennywise.custom.SelectDateFragment;
import com.budgettracking.pennywise.custom.SparseBooleanArrayParcelable;
import com.budgettracking.pennywise.custom.WrapContentManagerRecyclerView;
...
import com.budgettracking.pennywise.ui.expenses.ExpenseDetailActivity;
...
import com.budgettracking.pennywise.utilities.FileManager;
import com.budgettracking.pennywise.utilities.HistoryFileParser;
...
public class HistoryFragment extends MainFragment implements BaseViewHolder.RecyclerClickListener, ISelectDateFragment {
    ...
    //Updates data based on data store.
    @Override
    public void updateData() {
        ...
        selectDateFragment.getTextViewTotal().setText(Utilities.getFormattedCurrency(total));
    }
    ...
    //When user long clicks an object. set action mode.
    @Override
    ...
    private void writeFile() {
        ...
        titleBuilder.append(getString(R.string.app_name)).append(" ").append(Utilities.formatDateToString(DateManager.getInstance().getDateFrom(), Utilities.getCurrentDateFormat())).append(" - ").append(Utilities.formatDateToString(DateManager.getInstance().getDateTo(), Utilities.getCurrentDateFormat()));
