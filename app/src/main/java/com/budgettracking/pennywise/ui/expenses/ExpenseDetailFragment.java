...
public class ExpenseDetailFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void loadData() {
        ...
        tvExpenseTotal.setText(Utilities.getFormattedCurrency(expense.getTotal()));
        ...
        ((TextView)getView().findViewById(R.id.tv_date)).setText(Utilities.formatDateToString(expense.getDate(), Utilities.getCurrentDateFormat()));
    ...
    //Sets up the chart for expense details
    private void setWeekChart() {
        List<Date> dateList = DateUtilities.getWeekDates();
